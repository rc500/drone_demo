...
(cl:defmethod cl:initialize-instance :after ((m <HullSelect-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HullSelect-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_demo-srv:<HullSelect-request> is deprecated: use drone_demo-srv:HullSelect-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <HullSelect-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HullSelect-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_demo-srv:<HullSelect-response> is deprecated: use drone_demo-srv:HullSelect-response instead.")))
