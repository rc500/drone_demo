...
(cl:defmethod cl:initialize-instance :after ((m <LedAnim-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LedAnim-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_demo-srv:<LedAnim-request> is deprecated: use drone_demo-srv:LedAnim-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <LedAnim-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_demo-srv:type-val is deprecated.  Use drone_demo-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'freq-val :lambda-list '(m))
(cl:defmethod freq-val ((m <LedAnim-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_demo-srv:freq-val is deprecated.  Use drone_demo-srv:freq instead.")
  (freq m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <LedAnim-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_demo-srv:duration-val is deprecated.  Use drone_demo-srv:duration instead.")
  (duration m))
...
(cl:defmethod cl:initialize-instance :after ((m <LedAnim-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LedAnim-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_demo-srv:<LedAnim-response> is deprecated: use drone_demo-srv:LedAnim-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <LedAnim-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_demo-srv:result-val is deprecated.  Use drone_demo-srv:result instead.")
  (result m))
